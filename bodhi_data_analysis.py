...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 27 22:04:49 2025
...
class Data_analysis:
        ...
        for indicator in self.indicators:
            if indicator.s_test is not None:
                ...
                with pd.ExcelWriter(file_path, engine='openpyxl', mode='a', if_sheet_exists='overlay') as writer:
                    s_df.to_excel(writer, sheet_name=sheet_name, index=True, header=True)
    ...
    def breakdown_percentage_bar(self, indicator, df, colname, file_path, figsize=(12, 8), rotation=0, fontsize=12):
        ...
        for i in ax.containers:
            ax.bar_label(i, labels=[f'{p:.0f}%' for p in df[i.get_label()]], label_type='edge', fontsize=fontsize_auto+2)
